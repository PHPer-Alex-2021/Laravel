...
-- ----------------------------
-- Table structure for arts_comments
-- ----------------------------
DROP TABLE IF EXISTS `arts_comments`;
CREATE TABLE `arts_comments`  (
...
) ENGINE = MyISAM AUTO_INCREMENT = 87 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
