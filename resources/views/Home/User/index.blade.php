    ...
    <div class="card">
        <div class="card-header">
            ...
            <form action="{{route('search')}}" method="post">
                ...
                <div class="input-group col-lg-5  fa-pull-left"  style="width:30%;margin-top:30px;">
                    <select class="form-control" id="project">
                        <option value="0">请选择类型</option>
                        @foreach ($projects as $project)
                            <option value="{{ $project->is_admin }}">
                                @if($project->is_admin == 1)
                                    管理员
                                @else
                                    会员
                                @endif
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <a href="{{route('user.show',$user)}}"  type="button" class="btn btn-info mr-2">
                                        <i class="fas fa-id-card">查看</i>
                                    </a>
                                    @can('update',$user)
                                        <a href="{{route('user.edit',$user)}}" type="button" class="btn btn-success mr-2">
