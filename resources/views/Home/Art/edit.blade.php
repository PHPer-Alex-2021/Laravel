...
@section('content')
    ...
    <form action="{{route('art.update',$art)}}" method="post" id="art_form" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card">
            ...
            <div class="card-body">
                        ...
                        <div class="box">
                            <div class="info">
                                @foreach($art['imgs'] as $v)
                                    <img src="{{URL::asset('/uploads/artsImg/'.$v['img'])}}" width="200px" height="200px">
                                @endforeach
                            </div>
                        </div>
                    @endif
                ...
                <div class="form-group">
                    <label for="">介绍</label>
                    <textarea class="form-control" name="bcontent" id="" rows="3">
                        {{$art['content']}}
                    </textarea>
                </div>
