    ...
    <table cellpadding="0" align="center"
        ...
        <tr>
            <th valign="middle"
                ...
                <font face="微软雅黑" size="5" style="color: rgb(255, 255, 255); ">找回密码!（星影心推荐）</font>
            </th>
        </tr>
        <tr>
            <td>
                <div style="padding:25px 35px 40px; background-color:#fff;">
                    ...
                    <p>
                        密码忘记不用怕！<br>
                    <h2>
                        <a href="{{route('setNewPassword',['email'=>$user['email'],'password'=>$user['password']])}}">点击链接找回密码</a><br>
                    </h2>
                    当您在使用本网站时，遵守当地法律法规。<br>
                    如果您有什么疑问可以联系管理员，Email: 3278143864@qq.com
                    </p>
