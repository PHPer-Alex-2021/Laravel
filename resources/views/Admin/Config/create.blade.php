...
@section('inner_content')
    <form action="{{route('config.store')}}" method="post">
        @csrf
        <div class="card">
            <div class="card-header">添加系统设置</div>
            @include('Admin.Commont.errors')
            @include('Admin.Commont.message')
            <div class="card-body">
                <div class="form-group">
                    <label for="">标题</label>
                    <input type="text" class="form-control" name="conf_title" value="{{old('conf_title')}}">
                    <label for="">名称</label>
                    <input type="text" class="form-control" name="conf_name" value="{{old('conf_name')}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control conf_content" name="conf_content" value="{{old('conf_content')}}">
                    </div>
                    <div class="form-group">
                        <label for="">说明</label>
                    ...
                    <label for="">排序</label>
                    <input type="text" class="form-control" name="conf_order" value="{{old('conf_order')}}">
                </div>
            </div>
