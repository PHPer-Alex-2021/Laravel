...
@section('content_css')
    <link rel="stylesheet" href="{{URL::asset('css/Admin/Index/color_2.css')}}" />
@endsection
                           ...
                           <div id="testimonial_slider" class="carousel slide" data-ride="carousel">
                              ...
                              <div class="carousel-inner">
                                 <div class="item carousel-item active">
                                    <div class="img-box"><img src="{{URL::asset('images/Admin/Index/user_img.jpg')}}" alt=""></div>
         ...
         <div class="col-md-6 margin_bottom_30">
            <div class="dash_blog">
               <div class="dash_blog_inner">
                  <div class="dash_head">
                     <h3><span><i class="fa fa-calendar"></i> 6 July 2020</span><span class="plus_green_bt"><a href="#">+</a></span></h3>
                  </div>
                  <div class="list_cont">
                  ...
                  <div class="task_list_main">
                     <ul class="task_list">
                        <li><a href="#">Meeting about plan for Admin Template 2020</a><br><strong>10:00 AM</strong></li>
                        <li><a href="#">Create new task for Dashboard</a><br><strong>10:00 AM</strong></li>
                        <li><a href="#">Meeting about plan for Admin Template 2020</a><br><strong>11:00 AM</strong></li>
                        <li><a href="#">Create new task for Dashboard</a><br><strong>10:00 AM</strong></li>
                        <li><a href="#">Meeting about plan for Admin Template 2020</a><br><strong>02:00 PM</strong></li>
                     </ul>
                  </div>
                  <div class="read_more">
            ...
            <div class="dash_blog">
               <div class="dash_blog_inner">
                  ...
                  <div class="msg_list_main">
                     <ul class="msg_list">
                        <li>
                           <span><img src="{{URL::asset('images/Admin/Index/msg2.png')}}" class="img-responsive" alt="#" /></span>
                           <span>
                        ...
                        <li>
                           <span><img src="{{URL::asset('images/Admin/Index/msg3.png')}}" class="img-responsive" alt="#" /></span>
                           <span>
